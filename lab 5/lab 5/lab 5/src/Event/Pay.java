...
public class Pay extends Event {
	...
	private int customerInStore = arrival;// tänker att det kommer finnas en räknare i arrival som räknar antal
								   // inkommande?
	...
	public void doThis() {
		...
		state.getStore().customerPayed(); // registrera att pengar lagts till i getStore i State
