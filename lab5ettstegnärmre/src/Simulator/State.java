...
//	}
	...
	public void update(Event thisEvent) {
		...
		if(thisEvent.getClass() != Stop.class) {
			//Vet inte vad som händer med lediga kassatiden när kassa = stängd
			...
			//har inte uppdaterat senaste eventet till tid 9.08 och 9.10
			
			store.setTotCustomerQueueTime(timeBetweenEvent()*store.getRegisterQueue().size());
